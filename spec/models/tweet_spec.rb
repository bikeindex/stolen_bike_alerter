...
describe Tweet do
  ...
  describe :create_bike_index_post_hash do 
    it "should make a post hash" do 
      twitter_account = TwitterAccount.create(screen_name: ENV['TEST_SCREEN_NAME'],
      ...
      bike = Bike.create(bike_index_api_response: JSON.parse(bi_response), bike_index_api_url: 'https://bikeindex.org/api/v1/bikes/3414')
      bike.reload.serialize_api_response
      pp bike.bike_index_api_response[:id]
      bike.save
